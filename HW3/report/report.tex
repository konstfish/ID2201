...
% TODO: actually validate that the queue size isn't too big, logging seems weird right now, confirmed i'm just stupid the queue size is always printed by all the same logging outs
